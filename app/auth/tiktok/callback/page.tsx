...
export const metadata: Metadata = {
  ...
  description: "Página técnica de callback para el flujo OAuth de TikTok.",
...
export default async function TikTokCallback({
  ...
  const { code, state, scopes, error, error_description } = params;
  ...
  return (
    <main className="mx-auto flex min-h-[100dvh] max-w-[720px] flex-col items-start justify-center px-5 py-20 sm:px-8">
      ...
      <p className="mt-10 font-mono text-[11px] uppercase tracking-[0.25em] text-[var(--color-mute)]">
        TikTok OAuth <span className="eyebrow-sep">·</span> callback técnico
      </p>
      ...
      {error ? (
        <>
          ...
          <p className="mt-6 text-[15px] leading-relaxed text-[var(--color-ink-soft)]">
            TikTok ha devuelto un error en lugar del código. Detalles abajo, para diagnóstico.
          </p>
        ...
        <>
          ...
          <p className="mt-6 max-w-[58ch] text-[15px] leading-relaxed text-[var(--color-ink-soft)]">
            ...
            el script de OAuth de TikTok. La página se cierra sola cuando termines.
          </p>
        ...
        <>
          ...
          <p className="mt-6 max-w-[58ch] text-[15px] leading-relaxed text-[var(--color-ink-soft)]">
            Esta página solo se usa como redirect interno del flujo OAuth de TikTok. Si has
